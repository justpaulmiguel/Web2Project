...
<div class="w-full box-border h-screen bg-slate-100">
    ...
    <div class="flex w-full box-border text-lg text-slate-800 p-2 flex-col">
        ...
        <form method="get" action="deleteProcess.php" class="grid w-full grid-cols-1 grid-flow-row gap-x-[10px] lg:grid-cols-3 gap-y-0.5 md:grid-cols-2 p-2" onsubmit="return proceedDelete()">
                            ...
                            <div class="flex h-full flex-row object-contain overflow-hidden p-3 items-center">
                                ...
                                <div class="w-full h-full p-2">
                                    <div class="flex flex-col justify-center text-slate-100">
                                        ...
                                        <button type="submit" name="heroName" value="'.$heroName.'" class="w-1/3 bg-slate-100 text-slate-700 rounded-xl text-2xl">Delete</button>
                                    </div>
                                </div>
                            </div>
                        </div>';
