...
<div class="w-full box-border h-screen bg-slate-100">
    ...
    <div class="flex w-full box-border text-lg text-slate-800 p-2 flex-col">
        <h1 class="flex box-border w-full text-4xl font-semibold pt-2 pb-4 px-4 text-center text-slate-700 justify-center">Delete Records</h1>
        <form method="get" action="./process/deleteProcess.php" class="grid w-full grid-cols-1 grid-flow-row gap-x-[10px] lg:grid-cols-3 gap-y-0.5 md:grid-cols-2 p-2" onsubmit="return proceedDelete()">
                        ...
                        <div class="flex h-full flex-row object-contain overflow-hidden p-3 items-center">
                            ...
                            <div class="w-full h-full p-2">
                                <div class="flex flex-col justify-center text-slate-100">
                                    ...
                                    <button type="submit" name="heroName" value="'.$heroName.'" class="w-2/4 p-3 disabled:bg-slate-300 outline-none rounded-xl text-2xl text-slate-50 font-semibold bg-slate-500">Delete</button>
                                </div>
                            </div>
                        </div>
                    </div>';
